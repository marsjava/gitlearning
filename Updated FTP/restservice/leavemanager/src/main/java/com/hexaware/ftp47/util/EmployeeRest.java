...
public class EmployeeRest {
  ...
  @Path("{id}/manager")
  @Produces(MediaType.APPLICATION_JSON)
  public final Employee findManagerDetails(@PathParam("id") final int id) {
    final Employee employee = Employee.checkManager(id);
    if (employee == null) {
      throw new NotFoundException("No Manager found! ");
    }
    return employee;
  }
}
