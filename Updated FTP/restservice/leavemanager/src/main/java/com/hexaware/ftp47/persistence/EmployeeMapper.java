...
public class EmployeeMapper implements ResultSetMapper<Employee> {
  ...
  public final Employee map(final int idx, final ResultSet rs, final      StatementContext ctx) throws SQLException {
     ...
     * @return Employee
     */
    return new Employee(rs.getInt("EMP_ID"), rs.getString("EMP_NAME"), rs.getString("EMP_DATE"),
      rs.getInt("MANAGER_ID"), rs.getLong("EMP_PHONE"),
      rs.getString("EMP_DEPT"), rs.getString("EMP_EMAIL"), rs.getInt("EMP_LEAVE_AVAILABLE"));
  }
}
